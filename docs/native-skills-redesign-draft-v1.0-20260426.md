---
title: Native Skills Redesign — Replace BMAD Wrappers
version: 1.0
status: draft
author: Carson Sweet
...
**Purpose:** Replace 10 BMAD-wrapper skills with fully native SweetClaude skills, add one new skill, consolidate two competitive analysis skills into one, reorganize the product pipeline, and eliminate all BMAD dependencies from the framework.

---

## 1. Background

[1] Seven SweetClaude skills currently delegate their entire workflow to BMAD by calling `bmad:xxx` and following that workflow. BMAD is not installed in the current environment and was never deeply exercised. These skills are effectively dead code that silently fails at invocation. Three additional files (`skills/master/SKILL.md`, `rules/phase-gates.md`, `rules/interaction-model.md`) contain direct BMAD references that need removal.
...
### 2a. Skills Being Replaced (BMAD wrappers → native)

| Old skill | Wraps | Replacement |
|---|---|---|
| product-product-brief | bmad:product-brief | product-brief (also renamed) |
| product-prd | bmad:prd | product-prd (native) |
| product-user-story | bmad:create-story | product-user-stories (renamed + native) |
| product-research | bmad:research | product-research (native) |
| design-tech-spec | bmad:tech-spec | design-tech-spec (native) |
| design-ux | bmad:create-ux-design | design-ux (native) |
| design-architecture | bmad:architecture | design-architecture (native) |
...
### 2f. Files Needing BMAD Reference Removal

- `skills/master/SKILL.md` — references bmad:product-brief, bmad:brainstorm, bmad:research by name
- `rules/phase-gates.md` — references "BMAD 9-item checklist"
- `rules/interaction-model.md` — references stripping BMAD time estimates
...
| File | Change |
|---|---|
| `skills/master/SKILL.md` | Remove all `bmad:` references; update skill names for renamed skills |
| `rules/phase-gates.md` | Remove BMAD 9-item checklist reference; update phase skill lists |
| `rules/interaction-model.md` | Remove "strip BMAD time estimates" reference |
