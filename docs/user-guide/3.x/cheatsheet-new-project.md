...
- `/sweetclaude:product-milestones review` — see all milestones grouped by Now / Next / Later
- `/sweetclaude:product-milestones link US-XXX MS-XXX` — attach a story to a milestone
- `/sweetclaude:product-milestones blockers MS-XXX` — what is stopping progress
- `/sweetclaude:product-milestones complete MS-XXX` — mark achieved, capture follow-ups
...
- **Academic paper** (`/sweetclaude:documents-academic-research`) — full six-phase pipeline from thesis through submission
...
- **Update SweetClaude** — run `/plugin update sweetclaude@sweetclaude-stable`, restart Claude Code, then run `/sweetclaude:update` if framework files need syncing
