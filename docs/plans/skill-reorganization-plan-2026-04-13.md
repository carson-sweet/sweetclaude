...
| product/product-brief | **New wrapper** | Wraps bmad:product-brief + preflight guard |
| product/prd | **New wrapper** | Wraps bmad:prd |
| product/user-story | **New wrapper** | Wraps bmad:create-story |
...
| product/sprint-plan | **New wrapper** | Wraps bmad:sprint-planning |
| product/research | **New wrapper** | Wraps bmad:research |
| product/feature-competitive | **New** | Product-level competitive feature/capability analysis |

### design/ — 11 skills
| Skill | Status | Notes |
|---|---|---|
| design/architecture | **New wrapper** | Wraps bmad:architecture |
| design/tech-spec | **New wrapper** | Wraps bmad:tech-spec |
| design/ux | **New wrapper** | Wraps bmad:create-ux-design |
| design/solutioning-gate | **New wrapper** | Wraps bmad:solutioning-gate-check |
...
| Category | Exists/Move | New | BMAD Wrapper | Designed | Total |
|---|---|---|---|---|---|
...
### Phase 3: BMAD wrappers
Build 9 thin wrapper skills that add the preflight guard and SweetClaude context before delegating to BMAD.

Each wrapper:
- Has preflight-guard block
- Sets up SweetClaude context (current phase, deference level, relevant state)
- Invokes the BMAD skill
- Captures outputs to working repo

Skills:
1. product/product-brief → bmad:product-brief
2. product/prd → bmad:prd
3. product/user-story → bmad:create-story
4. product/sprint-plan → bmad:sprint-planning
5. product/research → bmad:research
6. design/architecture → bmad:architecture
7. design/tech-spec → bmad:tech-spec
8. design/ux → bmad:create-ux-design
9. design/solutioning-gate → bmad:solutioning-gate-check
