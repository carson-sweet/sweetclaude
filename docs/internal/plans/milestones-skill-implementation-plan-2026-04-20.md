...
```markdown
---
description: "Write user stories with acceptance criteria from features or epics. Wraps [removed] with SweetClaude context."
---
...
Invoke `[removed]` and follow its workflow.
```
...
1. Invoke `[removed]` and follow its workflow.
