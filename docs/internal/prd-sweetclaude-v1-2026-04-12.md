...
**Priority:** Must Have
**Description:** Formal transition from [removed] user stories to Gherkin `.feature` files that serve as the contract for TDD test generation.
**Acceptance Criteria:**
- [ ] [removed] stories with acceptance criteria → `.feature` files with Given/When/Then
...
#### FR-024: Superpowers & [removed] Integration
**Priority:** Must Have
**Description:** SweetClaude works alongside Superpowers and [removed] as upstream dependencies. Phase router delegates to appropriate [removed] workflows and Superpowers skills.
**Acceptance Criteria:**
- [ ] [removed] workflows invocable during Discover/Define/Design/Plan phases
...
**Priority:** Must Have — Built
**Description:** [removed] wrapper that invokes the Product Brief workflow with SweetClaude orchestration — phase awareness, deference levels, and decision logging integrated.

#### FR-053: PRD Wrapper
**Priority:** Must Have — Built
**Description:** [removed] wrapper that invokes the PRD workflow with SweetClaude orchestration — phase awareness, deference levels, and decision logging integrated.

#### FR-054: User Story Wrapper
**Priority:** Must Have — Built
**Description:** [removed] wrapper that invokes the Create Story workflow with SweetClaude orchestration — phase awareness, deference levels, and decision logging integrated.
...
**Priority:** Should Have — Built
**Description:** [removed] wrapper that invokes the Sprint Planning workflow with SweetClaude orchestration.

#### FR-060: Research Wrapper
**Priority:** Should Have — Built
**Description:** [removed] wrapper that invokes the Research workflow with SweetClaude orchestration.
...
**Priority:** Must Have — Built
**Description:** [removed] wrapper that invokes the Architecture workflow with SweetClaude orchestration — phase awareness, deference levels, and decision logging integrated.

#### FR-063: Tech Spec Wrapper
**Priority:** Must Have — Built
**Description:** [removed] wrapper that invokes the Tech Spec workflow with SweetClaude orchestration.

#### FR-064: UX Design Wrapper
**Priority:** Should Have — Built
**Description:** [removed] wrapper that invokes the Create UX Design workflow with SweetClaude orchestration.

#### FR-065: Solutioning Gate Wrapper
**Priority:** Must Have — Built
**Description:** [removed] wrapper that invokes the Solutioning Gate Check workflow with SweetClaude orchestration.
...
- [ ] Prerequisites clearly documented with minimum versions (Claude Code CLI, git, GitHub CLI, Superpowers 5.0.7+, [removed] 6.0.0+)
...
**Priority:** Must Have
**Description:** SweetClaude must not break Superpowers or [removed] functionality. It orchestrates, not overrides.
**Acceptance Criteria:**
- [ ] All Superpowers skills remain independently invocable
- [ ] All [removed] workflows remain independently invocable
- [ ] No hook conflicts
...
- [removed] Method 6.0.0+ (upstream dependency — product lifecycle)
...
- Superpowers plugin (5.0.7+) and [removed] Method (6.0.0+) installed as upstream dependencies
...
*Generated by [removed] Method v6 — Product Manager*
